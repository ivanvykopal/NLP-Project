...
class AFPDataset(Dataset):
    ...
    def convert_targets(self, target):
        ...
        false_names = [
            ...
            'doctored image', 'fabricated article', 'false - satire', 'altered image, misleading', 'false, altered news graphic',
            'misleading context', 'scam', 'fake', 'misrepresentation', 'photo détournée', 'fasle', 'falso', 'faux',
            'hoax', 'outdated guidance', 'engañoso', 'خطأ', 'manipulated image', 'satire/manipulated image',
        ...
        not_enough_info_names = [
            ...
            'canada funds hamas', 'satire', 'april fool', 'out of context', 'photo out of context',
